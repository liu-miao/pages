import{_ as n,c as e,d as a,o as i}from"./app-DOmc_oHg.js";const l="/assets/image-20241110034622365-B0BQli26.png",p={};function d(t,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h2 id="创建仓库" tabindex="-1"><a class="header-anchor" href="#创建仓库"><span>创建仓库</span></a></h2><p>用户名.github.io</p><h2 id="token创建" tabindex="-1"><a class="header-anchor" href="#token创建"><span>token创建</span></a></h2><p>settings</p><p>进入 左侧最下面 deploy</p><p>选择权限 点击生成</p><h2 id="填写token" tabindex="-1"><a class="header-anchor" href="#填写token"><span>填写token</span></a></h2><p>在仓库的配置中的Secrets and variables 中填上刚才的token</p><p>修改deploy-docs.yml</p><p>steps下面添加</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">        env:</span>
